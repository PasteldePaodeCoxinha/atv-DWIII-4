...
import com.autobots.automanager.adaptadores.UsuarioDetailsServiceImpl;
...
public class Seguranca extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private UsuarioDetailsServiceImpl servico;

	@Autowired
	private ProvedorJwt provedorJwt;

	private static final String[] rotasPublicas = { "/", "/usuario/cadastro", "/usuario/usuario/{id}" };
